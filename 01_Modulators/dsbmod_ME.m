% This function performs modulation for double-sideband suppressed-carrier (DSB-SC) modulation on a complex baseband signal.
%
...
n = (0:numel(x)-1);
y = complex(x.*exp(1i*2*pi*dfc_div_fs*n+1i*ini_phase));