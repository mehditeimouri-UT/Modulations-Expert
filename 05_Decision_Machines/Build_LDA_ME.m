function [LDA_CL,Pc,ConfusionMatrix,Pc_Train,ConfusionMatrix_Train] = Build_LDA_ME(Dataset,ClassLabels,FeatureLabels,Weights,TIndex,VIndex)
...
[~,Pc_Train,ConfusionMatrix_Train,~,~] = Test_LDA_ME(LDA_CL,Dataset,TIndex,ClassLabels,ClassLabels,FeatureLabels,FeatureLabels,Weights);
[~,Pc,ConfusionMatrix,~,~] = Test_LDA_ME(LDA_CL,Dataset,VIndex,ClassLabels,ClassLabels,FeatureLabels,FeatureLabels,Weights);
