% This function performs demodulation for phase modulation (PM) modulation on a complex baseband signal.
%
...
%% Demodulation
Df_div_fs = h/(2*sps);
x = diff(unwrap(angle(y))/(2*pi*Df_div_fs));
