% This function performs OQPSK demodulation on a complex baseband signal..
%
...
%       equal to L*Mod.sps+Mod.half_symbol and less than (L+1)*Mod.sps+Mod.half_symbol
%
% Output:
...
function [data,s_hat] = oqpskdemod_ME(Mod, y)
...
%% Demodulation: Considering the extra delay of T/2 seconds in the Q-channel
s_hat = real(y(half_symbol+1:sps:end-half_symbol))+...
    1i*imag(y(2*half_symbol+1:sps:end)); 

L = floor((length(y)-half_symbol)/sps);
s_hat = s_hat(1:L);
