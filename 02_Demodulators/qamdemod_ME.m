% This function performs QAM demodulation on a complex baseband signal.
%
...
function [data,s_hat] = qamdemod_ME(Mod, y)
...
ModSymbols = qam_constellation_ME(M).*exp(1i*phaserot); % Constellation points
